const projects = [
  ...
  { id: 8,  title: 'Concept #2',  category: 'Normal', desc: 'Visually striking concept content built to stop the scroll.', color: '#f59e0b', video: 'https://drive.google.com/file/d/1NEgm8ptwAswFbSVu_nQ92pXEuRmS3SeK/preview', thumb: 'https://drive.google.com/thumbnail?id=1NEgm8ptwAswFbSVu_nQ92pXEuRmS3SeK&sz=w800' },
  ...
  { id: 15, title: 'Concept #9',  category: 'Normal', desc: 'Concept-first content strategy that drives both reach and revenue.', color: '#06b6d4', video: 'https://drive.google.com/file/d/1NLzSEVaI4cOhlDhblltHLkHKuV9O9LrW/preview', thumb: 'https://drive.google.com/thumbnail?id=1NLzSEVaI4cOhlDhblltHLkHKuV9O9LrW&sz=w800' },
